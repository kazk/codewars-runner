...
// TODO: Error handling
function start(opts) {
  return Promise.all(opts.services.map(s => startService[s](opts)));
}
...
const startService = {
  ...
  mongodb: function(opts) {
    const dir = temp.mkdirSync('mongodb');
  ...
  mariadb: function(opts) { // TODO
  },
  couchdb: function(opts) { // TODO
  },
  rabbitmq: function(opts) { // TODO
  }
};
